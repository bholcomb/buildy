...
func NewPackageManager(workspaceRoot string, packageDirs []string, varEnv *util.VariableEnvironment) *PackageManager {
	pm := &PackageManager{
		packageDirs: []string{},
...
func (pm *PackageManager) resolveNewPackageFormat(pkg *Package, packageData map[string]any, platform, architecture string, varEnv *util.VariableEnvironment) {
...
func (pm *PackageManager) resolveHierarchicalStringList(data map[string]any, field, platform, architecture string, varEnv *util.VariableEnvironment) []string {
	result := []string{}
...
func (pm *PackageManager) resolveVariables(text string, varEnv *util.VariableEnvironment) string {
	errors := []string{}
