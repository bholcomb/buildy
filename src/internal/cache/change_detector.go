...
func (cd *ChangeDetector) IsCachedResultValid(task *workspace.BuildTask) bool {
...
func (cd *ChangeDetector) GetAffectedTasks(changes *ChangeSet, taskGraph *workspace.TaskGraph) map[string]bool {
...
func (cd *ChangeDetector) getDependentTasks(taskID string, taskGraph *workspace.TaskGraph) map[string]bool {
